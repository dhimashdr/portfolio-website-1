...
export default function CTA(){
    return (
        <div className="text-center flex flex-col gap-2 items-center">
            <h1 className="font-bold text-xl lg:text-3xl lg:w-1/2 text-balance">Tertarik untuk memesan kerajinan tembaga atau kuningan?</h1>
            <p className="font-light text-xs text-balance max-w-1/2 lg:text-md">Hubungi kami untuk mendapatkan informasi harga produk, konsultasi, atau pemesanan custom.</p>
            <br />
