...
export default function Section({title, subtitle} : {title : string, subtitle : string}){
    return <div className="w-full aspect-2/1 lg:aspect-5/1 relative">
        <Image src={"/images/section-background.jpg"} draggable="false" fill sizes="1" alt="section-background" className="object-cover" loading="eager"></Image>
        ...
        <p className="font-light text-xs lg:text-sm text-center text-balance">{subtitle}</p>
        </div>
    </div>
}